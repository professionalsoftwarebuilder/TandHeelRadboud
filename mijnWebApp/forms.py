...
class PoetsMomentForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            #'ptm_Moment': DateTimePickerInput({}),
            'ptm_Moment': AdminSplitDateTime(),
            #'ptm_Moment': AdminDateWidget(),
            #'ptm_Moment': DateInput(attrs={'class': 'date_picker'}),
        }
        field_classes = {
            'ptm_Moment': forms.SplitDateTimeField,
        }
        #fields = ['ptm_Interval', 'ptm_Toothpaste', 'ptm_Activity', 'ptm_Notes']
        #widgets = {'ptm_Interval': forms.DurationField(attrs={'disabled': 'True'})}
